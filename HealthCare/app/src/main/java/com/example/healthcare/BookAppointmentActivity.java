...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv= findViewById(R.id.tvbookapt);
        ed1=findViewById(R.id.edfullname);
        ed2= findViewById(R.id.edaddress);
        ed3  = findViewById(R.id.edcontactnumber);
        ed4 = findViewById(R.id.edfees);
        dateButton=findViewById(R.id.btndate);
        timeButton= findViewById(R.id.btntime);
        btnback=findViewById(R.id.btnbackod);
        btnbook= findViewById(R.id.btnappt);
...
btnbook.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        if (db.checkAppointmentExists(username, title +" =>"+ fullname, address,contact, dateButton.getText().toString(),timeButton.getText().toString())==1){
         ...
         Toast.makeText(getApplicationContext(), "Your Appointment has been booked ", Toast.LENGTH_LONG).show();
